...
████████████████████████████████████████████████████████████████████
  ...
  (담당: AI 엔진 · 데이터 · 백엔드 로직 — 자세한 역할 구분은 "누가 무엇을 만들었나" 참고)
████████████████████████████████████████████████████████████████████
-->
...
2인 팀 프로젝트입니다. 이 README는 그중 **AI 엔진 · 데이터 · 백엔드 로직을 담당한
[wouldu0](https://github.com/wouldu0/)** 기준으로 작성했습니다.

| 담당 | 범위 |
|:---|:---|
| **[wouldu0](https://github.com/wouldu0/) (본인)** | AI 생성 엔진 설계·학습(Seq2Seq+REINFORCE), 재료 대체 모델(KLUE-BERT+KNN), 영양소 재조정 7단계 레버(`FOOK_adjust_levers.py`), RAG 영양 상담 챗봇, 영양 데이터셋 구축(식약청 영양성분표 대조·정제, 메뉴·재료 DB), 성능 벤치마크·회귀 검증, 임상영양사 검수 문서 작성 |
| **팀원** | 프론트엔드(React) 구현, Vercel/Render 배포 파이프라인 |

아래 문서의 "🎛️ 핵심 기술", "📐 영양 기준 산출 방식", "🗂️ 파일 구조"의 `backend/` ·
`model-development/` 항목이 본인이 만든 부분입니다.
...
> ↑ [누가 무엇을 만들었나](#-누가-무엇을-만들었나)는 목차 위, 훈련 과정 정보 바로 아래에 있습니다.
