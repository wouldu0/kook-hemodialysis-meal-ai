...
def main():
    ...
    with Path('foodbert/data/used_ingredients.json').open(encoding='utf-8') as f:
        used_ingredients = json.load(f)  # Dont seperate these
    tokenizer = AutoTokenizer.from_pretrained('C:/klue-bert', never_split=used_ingredients)
